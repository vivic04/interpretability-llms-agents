...
EXAMPLES = {
    ...
    "Example 3 — Ignorance & Bigotry (BERT vs GPT2 disagree)": {
        "text": "ignorance and bigotry comes from your post",
        "gemini_flash": {"label": "Non-Toxic", "confidence": 82},
        "gemini_pro":   {"label": "Non-Toxic", "confidence": 85},
        "gemini_lite":  {"label": "Non-Toxic", "confidence": 79},
        "bert": {
            "label": "Non-Toxic", "confidence": 89,
            "tokens": filter_tokens([
                ("ignorance", -0.020488),
                ("and",        0.189009),
                ("bigotry",    0.047103),
        ...
        "distilgpt2": {
            "label": "Toxic", "confidence": 71,
            "text_override": "ignorance and bigotry comes from your post",
            "tokens": filter_tokens([
                ("ign",      1.151528),
                ("or",      -7.260700),
                ("ance",    -4.850616),
        ...
        "abuse_breakdown": {
            "Threat": 0, "Scam": 0, "Identity-based Abuse": 35,
            "Harassment": 20, "Coercion": 0, "Sexual Harassment": 0,
            "Profanity / Obscenity": 5, "Self-harm Concern": 0,
            "Doxxing": 0, "Other Abusive": 8,
        },
        "ground_truth": "Non-Toxic",
        "severity": "Low",
        "confidence_gt": 85,
    ...
    "Example 4 — Racism & Politics (both models agree toxic)": {
        "text": "between racist eastman and slappy wilson wasilla delegation is embarassment to valley and state both should resign this is trumps america open racism in republican party and physical attacks on reporters",
        "gemini_flash": {"label": "Toxic", "confidence": 88},
        "gemini_pro":   {"label": "Toxic", "confidence": 91},
        "gemini_lite":  {"label": "Toxic", "confidence": 85},
        "bert": {
            "label": "Toxic", "confidence": 68,
            "tokens": filter_tokens([
                ("between",     0.010388),
                ("racist",      0.008147),
                ("eastman",     0.001883),
        ...
        "abuse_breakdown": {
            "Threat": 8, "Scam": 0, "Identity-based Abuse": 42,
            "Harassment": 25, "Coercion": 0, "Sexual Harassment": 0,
            "Profanity / Obscenity": 5, "Self-harm Concern": 0,
            "Doxxing": 0, "Other Abusive": 10,
        },
        "ground_truth": "Toxic",
        "severity": "High",
        "confidence_gt": 91,
    ...
    "Example 5 — School Violence (BERT non-toxic, GPT2 toxic)": {
        "text": "there are no words for these senseless acts god help us all if we do not learn that evil lurks even in face of these teenagers such violence against their peers should make everyone take pause be safe children",
        "gemini_flash": {"label": "Non-Toxic", "confidence": 90},
        "gemini_pro":   {"label": "Non-Toxic", "confidence": 93},
        "gemini_lite":  {"label": "Non-Toxic", "confidence": 88},
        "bert": {
            "label": "Non-Toxic", "confidence": 91,
            "tokens": filter_tokens([
                ("there",      0.004603),
                ("are",        0.007920),
                ("no",         0.008073),
        ...
        "abuse_breakdown": {
            "Threat": 0, "Scam": 0, "Identity-based Abuse": 0,
            "Harassment": 5, "Coercion": 0, "Sexual Harassment": 0,
            "Profanity / Obscenity": 0, "Self-harm Concern": 15,
            "Doxxing": 0, "Other Abusive": 8,
        },
        "ground_truth": "Non-Toxic",
        "severity": "Low",
